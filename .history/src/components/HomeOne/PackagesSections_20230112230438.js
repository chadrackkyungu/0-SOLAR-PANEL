                                ...
                                <div className="col-lg-4 col-md-6 wow animated fadeInLeft">
                                    <div className="pricing-one__single">
                                        ...
                                        <div className="pricig-body">
                                            <ul>
                                                <li>  <i className="fal fa-check py-4" /> Solar Energy Output: 2.5 KWh/Day Run 8 x 5 watt LEDs + TV + DSTV + Computer</li>
                                                <li> <i className="fal fa-check py-4" /> 2400 WATT inverter with MPPT & AC battery charger </li>
                                                <li> <i className="fal fa-check py-4" /> 2 x 100Ah deep cycle batteries + 2 x 250W panels Will run off grid and charge from AC Maximum peak power: 3 KVA
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
