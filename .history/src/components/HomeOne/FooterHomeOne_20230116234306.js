                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="footer-about-widget">
                                ...
                                <p>
                                    solar panel technology is a solar panel system that utilizes renewable organic materials to produce energy. The technology was developed by Giantech Software Solutions, a leading provider of software and hardware solutions for solar energy.
                                </p>
